...
export default function RegistrarMedicoModal({ show, onClose, onSuccess }) {
    ...
    return (
        ...
        >
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content card shadow border-0">
                    <div className="card-header bg-success text-white d-flex justify-content-between align-items-center">
                        <h4 className="m-0">Registrar Médico</h4>
                        <button
                            type="button"
