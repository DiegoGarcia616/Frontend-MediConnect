...
export default function AdminTotalMedicos() {
  ...
  const [formEditar, setFormEditar] = useState({ idEspecialidad: "", idSede: "" });
  ...
  const handleAbrirEditar = (medico) => {
    ...
    setFormEditar({ idEspecialidad: medico.idEspecialidad || "", idSede: medico.idSede || "" });
    setShowEditar(true);
  };
  ...
  const handleCerrarEditar = () => {
    ...
    setFormEditar({ idEspecialidad: "", idSede: "" });
  };
  ...
  const handleSubmitEditar = async (e) => {
    ...
    const ok = await actualizarEspecialidadYSede(
      ...
      formEditar.idSede ? Number(formEditar.idSede) : null
    );
    ...
    <div style={{ padding: "2rem", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div className="page-header">
        <div className="header-left">
          ...
          <div>
            ...
            <div className="page-subtitle">{medicos.length} médicos con datos completos</div>
          </div>
        </div>
      </div>
      ...
      {pendientes.length > 0 && (
        <div className="pendientes-box">
          <div className="pendientes-titulo">
            ...
            {pendientes.length} médico(s) pendientes de completar datos profesionales
          </div>
      ...
      {medicosFiltrados.length === 0 ? (
        <div className="empty-state">
          <p style={{ fontSize: "1.1rem" }}>No se encontraron médicos con datos completos</p>
        </div>
      ) : (
              ...
              <tbody>
                {medicosFiltrados.map((m) => (
                  <tr key={m.idMedico}>
                    ...
                    <td className="sede-txt">{m.nombreSede || "Sin sede"}</td>
                    <td>
                      <button
                    ...
                    <td>
                      <div className="acciones-cell">
                        <button className="action-btn edit" onClick={() => handleAbrirEditar(m)} title="Editar especialidad/sede">
      ...
      {showEditar && medicoEditar && (
        <div className="modal-overlay">
          <div className="modal-box">
            <div className="modal-header">
              <div className="modal-title">Editar especialidad y sede</div>
            ...
            <form onSubmit={handleSubmitEditar}>
              ...
              <select
                className="modal-input"
                value={formEditar.idSede}
                onChange={(e) => setFormEditar((prev) => ({ ...prev, idSede: e.target.value }))}
              >
